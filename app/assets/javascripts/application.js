...
$(document).ready(function(){
            ...
            $(window).scroll(function(){
                ...
                if ( $(this).scrollTop() > 700 && $nav.hasClass("default") ){

                    $nav.removeClass("default").addClass("fixed");

                } else if ($(this).scrollTop() <= 700 && $nav.hasClass("fixed")) {
                ...
                if ( $(this).scrollTop() > 350 && $nav.hasClass("default") ){

                    $nav.removeClass("default").addClass("fixed");

                } else if ($(this).scrollTop() <= 350 && $nav.hasClass("fixed")) {
